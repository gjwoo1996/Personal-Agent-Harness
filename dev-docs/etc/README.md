...
| 문서 | 내용 |
|------|------|
| [01-요청-배경.md](01-요청-배경.md) | 2026-06-09 당시 요청과 문제의 과거 기록 |
| [02-논의-및-결정.md](02-논의-및-결정.md) | npm 전환 당시 논의의 과거 기록 |
| [03-진행-완료.md](03-진행-완료.md) | npm 배포 당시 완료 내역의 과거 기록 |
| [04-남은-작업.md](04-남은-작업.md) | 폐기된 npm 배포 잔여 작업 기록 |
| [05-npm-배포-가이드.md](05-npm-배포-가이드.md) | 폐기된 npm publish 절차의 과거 이력 |
| [06-사용법-요약.md](06-사용법-요약.md) | 현재 GitHub npx 사용법과 과거 방식 비교 |
...
**과거 해결 방향:** copy mode 유지 + 프로젝트 밖 도구화 → npm/npx CLI로 `init`/`update`
**현재 상태:** npm 배포 이력은 보존하되, 2026-07-28부터 GitHub 전용 배포로 전환
